...
var createUser_1 = require("../service/users/createUser");
var lodash_1 = require("lodash");
var logger_1 = __importDefault(require("../logger"));
var createUserHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_1, newError;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, createUser_1.createUser)(req.body)];
            case 1:
                user = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                newError = error_1;
                logger_1.default.error(newError);
...
var createUserSessionHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_2, newError;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
