...
userSchema.methods.comparePassword = function (candidatePasswords) {
    return __awaiter(this, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            user = this;
            return [2 /*return*/, bcrypt_1.default.compare(candidatePasswords, user.password).catch(function (e) { return false; })];
        });
    });
};
