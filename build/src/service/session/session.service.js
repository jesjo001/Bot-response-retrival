...
var createUser_1 = require("../users/createUser");
...
function createAccessToken(_a) {
    ...
    var accessToken = (0, jwt_utils_1.sign)(__assign(__assign({}, user), { session: session._id }), { expiresIn: config_1.default.get("accessTokenTtl") } // 15 minutes
    );
    return accessToken;
}
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!session || !(session === null || session === void 0 ? void 0 : session.valid))
                        return [2 /*return*/, false];
                    return [4 /*yield*/, (0, createUser_1.findUser)({ _id: session.user })];
                case 2:
                    user = _b.sent();
                    if (!user)
                        return [2 /*return*/, false];
